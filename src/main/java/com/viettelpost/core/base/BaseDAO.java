...
public class BaseDAO {
    ...
    private CallableStatement buildStatement(SessionFactory em, String procedureNameNoParam, List<Object> params,
                                             int outType, int count) throws Exception {
        Connection connection = getConnection(em);
        StringBuilder sql = new StringBuilder("{call ").append(procedureNameNoParam);
        sql.append("(");
        if (params != null) {
                ...
                if (b != null) {
                    if (b instanceof java.util.Date) {
                        ...
                        if (b instanceof String) {
                            ...
                            statement.setBoolean(j, (Boolean) b);
                        } else {
                            statement.setInt(j, Integer.valueOf(b.toString()));
                        }
                    }
    ...
    protected ResultSet[] getListResultSet(SessionFactory em, String procedureNameNoParam, List<Object> params,
                                           int count, int timeout) throws Exception {
    ...
    protected BigDecimal getBigDecimal(SessionFactory em, String procedureNameNoParam, List<Object> params,
                                       int outType) throws Exception {
        CallableStatement statement = buildStatement(em, procedureNameNoParam, params, outType, 1);
        int outIndex = 1;
        if (params != null) {
            outIndex = params.size() + 1;
    ...
    private void buidObject(ResultSet rs, ResultSetMetaData metaData, Map<String, Object> jO, DateFormat format,
                            int i) throws Exception {
        String colName = metaData.getColumnName(i + 1).toLowerCase(Locale.ROOT);
    ...
    private void buidObjectNoFormat(ResultSet rs, ResultSetMetaData metaData, Map<String, Object> jO, int i) throws
            Exception {
